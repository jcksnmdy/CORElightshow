...
class PlayerApp:
    ...
    def station_selection_menu(self, error=None):
        ...
        return self.stations[self.screen.get_integer(sys.argv[2])]
    ...
    def pause_song(self, song):
        self.screen.print_success("Pausing")
        self.player.pause()
    ...
    def quit(self, song):
        self.player.end_station()
        self.player.stop()
        self.screen.print_success("Quitting")
        self.player.play_station(100)
        self.player.stop()
        sys.exit(1)
    ...
    def _parse_args(self):
        ...
        parser.add_argument(
            "-t",
            dest="track",
            help="The track to play. (1 arguement)",
        )
        parser.add_argument(
            "-v",
            dest="verbose",
